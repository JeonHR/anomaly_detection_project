...
def analyze_site_commonality(df, anomalies, anomaly_counts_df, site_col="Site", EVALU_DIR="evaluation_reports"):
    """
    ✅ Site별 이상값 공통 발생 분석
    ...
    for col in anomalies.columns:
        ...
        # ✅ Site별 이상값 개수 집계
        site_anomalies = df[df[col] == 1].groupby(site_col).size()
        ...
        for site, ratio in site_anomaly_ratio.items():
            ...
            site_report.append(f"   - 이상값 개수: {site_anomalies[site]}")
